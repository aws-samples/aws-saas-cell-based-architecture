...
`sh ./lib/saas-management/cell-management-system/scripts/test_createcell.sh freetier S 1`
...
`sh ./lib/saas-management/cell-management-system/scripts/test_createtenant.sh o2345v9 tenant1 test@test.com free`
...
`sh ./lib/saas-management/cell-management-system/scripts/test_activatetenant.sh o2345v9 mhmuy9t2p`
